...
namespace Services
{
	public class GameService
	{
		...
		private const string IsShowRate = "isr";

		// list of day that will show rate us.
		private readonly List<int> dayShowRate = new() { 1, 2, 10, 30 };
		...
		public void Rate()
		{
			PlayerPrefs.SetInt(IsShowRate, 1);
#if UNITY_ANDROID
		...
		{
			if (GetRate() == true || PlayerPrefs.GetInt(IsShowRate, 0) == 0)
			{
				return false;
			}
